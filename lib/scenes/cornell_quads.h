...
std::unique_ptr<Scene> create_cornell_quads() {
  ...
  scene->add_volume(Plane(vec3(0.0f, -5.0f, 0.0f), vec3(0.0f, 1.0f, 0.0f)), white)
      ...
      .add_volume(Quad(vec3(-1.0f, 4.95f, -4.0f),
                       vec3(1.0f, 4.95f, -4.0f),
                       vec3(-1.0f, 4.95f, -2.0f)),
                  light)
      .add_volume(
          Quad(vec3(0.0f, 1.0f, -3.0f), vec3(1.0f, -0.0f, -1.2f), vec3(2.7f, 1.8f, -3.0f)),
          white)
      .add_volume(Quad(vec3(0.0f, -2.0f, -4.0f),
                       vec3(-2.7f, 0.4f, -4.3f),
                       vec3(-1.6f, -2.2f, -3.0f)),
                  red);
